...
>
> **32 games across four rooms of the arcade:**
...
>
> **جرّب قبل أن تشتري.** لعبتا «الثعبان» و«لعبة الذاكرة» مجانيتان، وبلا إعلانات أيضًا.
>
...
`retro,arcade,classic,snake,solitaire,puzzle,80s,90s,offline,no ads,pixel,nostalgia`
...
1. Catalog (hero shot: neon grid of 32 games)
2. Snake gameplay with scanlines
3. Brick Breaker mid-volley
4. Haunted Maze chase
5. Purchase screen ("$4.99 — everything forever, no ads ever")
6. Arabic catalog (RTL) — shows localization
7. Settings with the plain-language privacy statement
