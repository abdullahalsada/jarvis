...
// NOTE: duck_*, dog_*, island_kid_*, snail_bug, cobra and the *_bg scene
// images in assets/actors/ are AI-painted originals managed outside this
// generator — do not add maps for them here or they'll be overwritten.
const SPRITES = {
  // ─── Road Hopper ───
  frog: [
    '................',
